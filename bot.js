...
client.on('ready', () => {
  ...
  "f!bilgi = Botun bilgilerini gösterir. \n f!istatistik = Botun istatistiklerini gösterir. \n f!ekip = Mafya ekibini gösterir. \n f!ekle = Botun ekleme linkini gösterir. \n f!sunucular = Haraca bağlanan sunucular. \n f!tavsiye = Tavsiyenizi iletir. ")

  .addField(":cry: Mod Komutları :hammer: ",

  " ***Şu anda çalışmıyorlar!*** \n f!temizçek = Kanalı tamamen temizler. \n f!temizle <sayı> = Belirtilen sayı kadar mesaj siler.")

  .addField(":joy: Eğlence Komutları :stuck_out_tongue: ",

  "***Bakımda...***\n f!replik = En efsane filim repliklerini gösterir.\n f!replikyazı = Daha çok replik gösterir ancak resim olmadan. \n f!yazıtura = Yazı tura atar şansına ne gelirse.\n f!havalıyürü = Havalı yürür. \n f!havalıyumruk = Havalı bir şekilde yumruk atar.\n f!selamla = Politakacı gibi selamlar. \n f!tokatla = Birini tokatlar. \n f!topuğunasık = Birinin topuğuna sıkar. \n f!fragman = The Godfather orjinal fragmanını gösterir. \n f!avatar = Profil fotoğrafını gösterir.")
